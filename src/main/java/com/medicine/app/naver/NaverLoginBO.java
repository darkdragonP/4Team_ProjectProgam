package com.medicine.app.naver;
...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "V5PQLyNpqqh147N1xmEZ"; // 네이버API Client ID
	private final static String CLIENT_SECRET = "dOyh_EN8ne";
	private final static String REDIRECT_URI = "http://220.87.1.106:8080/app/callback.do";
