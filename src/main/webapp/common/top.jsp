...
<script async src="https://www.googletagmanager.com/gtag/js?id=G-5Q1QYDL0EX"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-5Q1QYDL0EX');
</script>
</head>
<body>
	<!-- Navigation -->
	<nav
		...
		<div class="container">
			<a class="navbar-brand" href="index.html"><span style="float:left;"><img src="images/HOMEDICINE4.jpg" alt="logo" /></span>	
			</a>
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a class="nav-link" href="medicineList.do">medicine</a>
					</li>
					...
					<li class="nav-item"><a class="nav-link" href="userdetail.do">회원정보수정</a>
					</li>				
					<li class="nav-item"><a class="nav-link" href="adminMain.do">관리자 페이지</a>
					</li>				
