		...
		<div class="container">
			<div class="row">
				<div class="col-xl-9 mx-auto">
					<h1 class="mb-5">
						HOMEDICINE에서 <br>53,000여개의 약 데이터를 만나보세요!
					</h1>
				</div>
					...
					<form action="searchTextMedicine.do">
						<div class="form-row">
							<div class="col-12 col-md-9 mb-2 mb-md-0">
								<input type="text" name="textMedicine"
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
						<div class="center">
							<a href="medicineList.do"><img src="images/medicines.png"
						...
						<div class="center">
							...
							<c:choose>
								<c:when test="${empty uIdx}">
									<a href="javascript:alert('로그인 후 이용 가능합니다.');" ><img
										src="images/mobile-payment.svg"
										style="width: 100px; height: 100px;"></a>
z									</c:when>
						...
						<br>
						<h3>유료회원이 아니신가요?</h3>
						<p class="lead mb-0">결제 후 처방전 등록, 약모양 검색 등 더 많은 서비스를 만날 수
							있습니다.</p>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="features-icons-item mx-auto mb-0 mb-lg-3">
						<div class="center">
							<a href="Contact.do"><img src="images/pharmacy.png"
								style="width: 100px; height: 100px;"></a>
						</div>
						<br>
						<h3>주변 약국 검색하기</h3>
