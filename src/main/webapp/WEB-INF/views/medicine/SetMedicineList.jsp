					...
					<form action="searchRadioMedicine.do">
						<div class="shape">
							<div style="border: 1px solid hidden; float: left; width: 17.2%;">
								<div>
									<input type="radio" name="mdShape" value="원형"> <img
										src="images/shape01.jpg" alt="원형">
								</div>
							</div>
							&nbsp;
							<div style="border: 1px solid hidden; float: left; width: 17.2%;">
							...
							<div style="clear: both;">
								<div
									style="border: 1px solid hidden; float: left; width: 17.2%;">
									<div>
						...
						<div class="Type">
							<div style="border: 1px solid hidden; float: left; width: 30%;">
								<div>
									<input type="radio" name="mdType" value="정제류"> <img
										src="images/type01.jpg" alt="정제류">
								</div>
							</div>
							<div style="border: 1px solid hidden; float: left; width: 30%;">
								<div>
									<input type="radio" name="mdType" value="경질캡슐"> <img
										src="images/type02.jpg" alt="경질캡슐">
								</div>
							</div>
							<div style="border: 1px solid hidden; float: left; width: 30%;">
								<div>
									<input type="radio" name="mdType" value="연질캡슐"> <img
										src="images/type03.jpg" alt="연질캡슐">
								</div>
							</div>
						</div>
						<br> <br>
						...
						<div class="mdLine">
							<div style="border: 1px solid hidden; float: left; width: 25%;">
								<div>
									<input type="radio" name="mdLine" value=""> <img
										src="images/line01.jpg" alt="없음">
								</div>
							</div>
							<div style="border: 1px solid hidden; float: left; width: 25%;">
								<div>
									<input type="radio" name="mdLine" value="-"> <img
										src="images/line02.jpg" alt="(-)형">
								</div>
							</div>
							<div style="border: 1px solid hidden; float: left; width: 25%;">
								<div>
									<input type="radio" name="mdLine" value="+"> <img
										src="images/line03.jpg" alt="(+)형">
								</div>
							</div>
							<div style="border: 1px solid hidden; float: left; width: 25%;">
								<div>
