											...
											<div class="tmp_profile">
												<table class="tmp_profile_tb">
													...
													<tbody>
														...
														<tr>
															<th scope="row"><span class="title">식약처 분류</span></th>
															<td>${medicine.getMdClass()}</td>
														</tr>


														<tr>
															<th scope="row"><span class="title">구분</span></th>
															<td>${medicine.getMdGrade()}</td>
														</tr>


														<tr>
															<th scope="row"><span class="title">제조(수입)
																	업체명</span></th>
														...
														<tr>
															<th scope="row"><span class="title">제형</span></th>
															<td>${medicine.getMdType()}</td>
														</tr>


														<tr>
															<th scope="row"><span class="title">모양</span></th>
														...
														<tr>
															<th scope="row"><span class="title">약 분할선</span></th>
			...
			<div class="col-md-4 blog-right-side">
				...
				<div class="card my-4">
					...
					<div class="card-body">
						...
						<h5><strong>[별점 이미지]&nbsp;&nbsp;&nbsp;${medicine.mdRating}점</strong></h5>
					</div>
				</div>
				<!-- Side Widget -->
				<div class="card my-4">
