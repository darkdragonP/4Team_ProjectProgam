		...
		<ul class="pagination">
			<c:if test="${mdBCounts.curRange ne 0}">
				<li class="page-item"><b class="page-link"><a
						href="searchRadioMedicine.do?mdShape=${mdBCounts.mdShape}&mdColor=${mdBCounts.mdColor}&mdType=${mdBCounts.mdType}&mdLine=${mdBCounts.mdLine}&curRange=${mdBCounts.curRange}&result=1">이전</a></b></li>
			</c:if>
					...
					<c:when test="${pageNum eq  mdBCounts.curPage}">
						<span style="font-weight: bold;"><b class="page-link"
							style="background-color: lightpink;"><a
								href="searchRadioMedicine.do?mdShape=${mdBCounts.mdShape}&mdColor=${mdBCounts.mdColor}&mdType=${mdBCounts.mdType}&mdLine=${mdBCounts.mdLine}curPage=${pageNum}&curRange=${mdBCounts.curRange}&startp=${mdBCounts.startPage}"
								onClick="fn_paging('${pageNum }')">${pageNum }</a></b></span>
					</c:when>
					<c:otherwise>
						<li><b class="page-link"> <a
								href="searchRadioMedicine.do?mdShape=${mdBCounts.mdShape}&mdColor=${mdBCounts.mdColor}&mdType=${mdBCounts.mdType}&mdLine=${mdBCounts.mdLine}&curPage=${pageNum}&curRange=${mdBCounts.curRange}&startp=${mdBCounts.startPage}">${pageNum}</a></b></li>
					</c:otherwise>
				</c:choose>
			</c:forEach>
