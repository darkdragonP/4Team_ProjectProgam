...
<body class="is-preload">
	<div class="container" align="center">
			...
			<div class="top">
				...
				<nav id="nav">
					<ul>
						...
						<br>
						<br>
						<li><a href="#type1" id="top-link"><span
								class="icon solid fa-th"><h6>분류 1</h6></span></a></li>
						<hr>
						<li><a href="#type2" id="about-link"><span
								class="icon solid fa-th"><h6>분류 2</h6></span></a></li>
						<hr>
						<li><a href="#type3" id="about-link"><span
								class="icon solid fa-th"><h6>분류 3</h6></span></a></li>
						<hr>
						<li><a href="#type4" id="about-link"><span
								class="icon solid fa-th"><h6>분류 4</h6></span></a></li>
						<hr>
						<li><a href="#type5" id="about-link"><span
								class="icon solid fa-th"><h6>분류 5</h6></span></a></li>
						<br>
						<br>
						<br>
		...
		<div class="breadcrumb-main">
			<ol class="breadcrumb">
				<li class="breadcrumb-item">Google Analytics</li>
			</ol>
